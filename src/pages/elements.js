      ...
      <article className="post-content page-template no-image">
        <div className="post-content-body">
          <p>
            ...
            . Finally, this is a <a href="https://www.w3schools.com">link</a>.
          </p>
          ...
          <ul className="actions">
            <li>
              <a href="https://www.w3schools.com" className="button primary">
                Primary
              </a>
            </li>
            <li>
              <a href="https://www.w3schools.com" className="button">
                Default
              </a>
            </li>
          </ul>
          <ul className="actions">
            <li>
              <a href="https://www.w3schools.com" className="button primary large">
                Large
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="https://www.w3schools.com" className="button small">
                Small
              </a>
            </li>
          </ul>
          <ul className="actions fit">
            <li>
              <a href="https://www.w3schools.com" className="button primary fit">
                Fit
              </a>
            </li>
            <li>
              <a href="https://www.w3schools.com" className="button fit">
                Fit
              </a>
            </li>
          </ul>
          <ul className="actions fit small">
            <li>
              <a href="https://www.w3schools.com" className="button primary fit small">
                Fit + Small
              </a>
            </li>
            <li>
              <a href="https://www.w3schools.com" className="button fit small">
                Fit + Small
              </a>
            </li>
          </ul>
